...
namespace {
                                            ...
                                            GG::Clr& color)
    {
        ...
        if (GetOptionsDB().Get<bool>("UI.autogenerated-effects-descriptions")) {
            ...
            if (!part->Effects().empty())
                detailed_description += str(FlexibleFormat(UserString("ENC_EFFECTS_STR")) % AutoGeneratedDescription(part->Effects()));
        }
    }
                                            ...
                                            GG::Clr& color)
    {
        ...
        if (GetOptionsDB().Get<bool>("UI.autogenerated-effects-descriptions")) {
            ...
            if (!hull->Effects().empty())
                detailed_description += str(FlexibleFormat(UserString("ENC_EFFECTS_STR")) % AutoGeneratedDescription(hull->Effects()));
        }
    }
                                            ...
                                            GG::Clr& color)
    {
        ...
        if (GetOptionsDB().Get<bool>("UI.autogenerated-effects-descriptions") && !tech->Effects().empty()) {
            detailed_description += str(FlexibleFormat(UserString("ENC_EFFECTS_STR"))
                % AutoGeneratedDescription(tech->Effects()));
        }
                                            ...
                                            GG::Clr& color)
    {
        ...
        if (GetOptionsDB().Get<bool>("UI.autogenerated-effects-descriptions")) {
            ...
            if (!building_type->Effects().empty())
                detailed_description += str(FlexibleFormat(UserString("ENC_EFFECTS_STR")) % AutoGeneratedDescription(building_type->Effects()));
        }
                                            ...
                                            GG::Clr& color)
    {
        ...
        if (GetOptionsDB().Get<bool>("UI.autogenerated-effects-descriptions")) {
            ...
            if (!special->Effects().empty())
                detailed_description += str(FlexibleFormat(UserString("ENC_EFFECTS_STR")) % AutoGeneratedDescription(special->Effects()));
        }
    }
                                            ...
                                            GG::Clr& color)
    {
        ...
        if (GetOptionsDB().Get<bool>("UI.autogenerated-effects-descriptions") && !species->Effects().empty()) {
            detailed_description += str(FlexibleFormat(UserString("ENC_EFFECTS_STR")) % AutoGeneratedDescription(species->Effects()));
        }
                                            ...
                                            GG::Clr& color)
    {
        ...
        if (GetOptionsDB().Get<bool>("UI.autogenerated-effects-descriptions")) {
            if (!field_type->Effects().empty())
                detailed_description += str(FlexibleFormat(UserString("ENC_EFFECTS_STR")) % AutoGeneratedDescription(field_type->Effects()));
        }
    }
